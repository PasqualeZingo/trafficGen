...
To print it remotely, type 
    ...
    lp -U 'reciever' -d 'VPDF' -h '<name of printer server VM].pfsense_domain.com/org/etc.>' <path-to-traficGen-repo>/trafficGen/agents/printThis.pdf
After this has been done successfully, a new file will appear in /home/reciever/PDF.
